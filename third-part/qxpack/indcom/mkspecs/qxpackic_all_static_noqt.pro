...
# /////////////////////////////////////////////////////////////////////////////
TEMPLATE = lib
CONFIG += c++11 skip_target_version_ext  unversioned_libname staticlib
CONFIG -= app_bundle
DEFINES *= QT_MESSAGELOGCONTEXT
QT *= core

CONFIG(debug,debug|release) {
    DEFINES *= QXPACK_IC_CFG_STATIC QXPACK_IC_CFG_STATIC_LIB
} else {
    DEFINES *= QXPACK_IC_CFG_STATIC QXPACK_IC_CFG_STATIC_LIB
...
QXIC_MODULE_COPY_FILES = \
     ...
     $$PWD/../qxpackic_all_static_noqt.pri \
     \
...
win32 {
    CONFIG( debug, debug|release ) {
        TARGET = $${QXIC_MODULE_TARGET}_static_noqt_d
        LIBS += kernel32.lib user32.lib gdi32.lib
    } else {
        TARGET = $${QXIC_MODULE_TARGET}_static_noqt
        LIBS += kernel32.lib user32.lib gdi32.lib
      #  QMAKE_CXXFLAGS *= /Zi
      #  QMAKE_CFLAGS *= /Zi
      #  QMAKE_LFLAGS *= /DEBUG
