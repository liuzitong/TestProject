#ifndef QXPACK_IC_QSGLINESERIESNODE_GLSL_4_3_P_HXX
#define QXPACK_IC_QSGLINESERIESNODE_GLSL_4_3_P_HXX
...
// ////////////////////////////////////////////////////////////////////////////
//
//                   the line series node ( GLSL 4.3 )
//
// ////////////////////////////////////////////////////////////////////////////
class QXPACK_IC_HIDDEN  IcQSGLineSeriesNodeGLSL4_3 : public IcQSGLineSeriesNode {
private:
...
public :
    explicit IcQSGLineSeriesNodeGLSL4_3(  QQuickItem *item );
    virtual ~IcQSGLineSeriesNodeGLSL4_3() Q_DECL_OVERRIDE;
