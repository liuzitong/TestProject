...
private:
    QSGGeometry  m_geom;
    QSGFlatColorMaterial  m_mater;
    QSGSimpleMaterial<Material>  *m_render_mater;

protected:
    void  qsg_updGeomVert( const QRectF &bounds, const LnParam &ln_param, const QRectF &vw_port, const Material &mater,  IcQuickLblLayoutSrc *lbl_layout );
    void  qsg_updGeomHori( const QRectF &bounds, const LnParam &ln_param, const QRectF &vw_port, const Material &mater,  IcQuickLblLayoutSrc *lbl_layout );
public :
    ...
    inline void qsg_updateGeometry( const QRectF &bounds, const LnParam &ln_param, const QRectF &vw_port, const Material &mater,  IcQuickLblLayoutSrc *lbl_layout )
    {
