...
// ////////////////////////////////////////////////////////////////////////////
// static atomic functions
// ////////////////////////////////////////////////////////////////////////////
// ============================================================================
// [ static ] initialize the atomic counter inplacement
// ============================================================================
void   IcVariant::PrivShared :: initRefCntr ( intptr_t *n, intptr_t v )
{
    new (n) IcAtomicInt(v);
}

// ============================================================================
// [ static ] deinit. the atomic counter inplacement
// ============================================================================
void   IcVariant::PrivShared :: deInitRefCntr( intptr_t *n )
{
    auto *ap = reinterpret_cast<IcAtomicInt*>(n);
    ap->~IcAtomicInt();
}

// ============================================================================
// [ static ] increase counter
// ============================================================================
intptr_t    IcVariant::PrivShared :: addRefCntr( intptr_t *n, intptr_t v )
{
    auto *ap = reinterpret_cast<IcAtomicInt*>(n);
    return ap->add(v);
}
...
// ============================================================================
// [ static ] decrease counter
// ============================================================================
intptr_t    IcVariant::PrivShared :: subRefCntr( intptr_t *n, intptr_t v )
{
    auto *ap = reinterpret_cast<IcAtomicInt*>(n);
    return ap->sub(v);
}
...
void  IcVariant :: detachSharedPtr ( )
{
    if ( isSharedObj() ) {
        if ( m_priv.u_data.v_sp->decRef() == 0 ) {
            m_priv.u_data.v_sp->delCbRef()( m_priv.u_data.v_sp );
