...
*/
/* ///////////////////////////////////////////////////////////////////// */
#ifndef  PERIMETER_PIMPLPRIVTEMP_HXX
#define  PERIMETER_PIMPLPRIVTEMP_HXX
...
#define PERIMETER_PImplPrivTemp_PtrCast( t, o ) (  reinterpret_cast< t >( reinterpret_cast< intptr_t >( o ))  )
#define PERIMETER_PImplPrivTemp_IntPtrCast( o ) (  reinterpret_cast< intptr_t >( o ))


#ifndef PERIMETER_PImplPrivTemp_new
#define PERIMETER_PImplPrivTemp_new( t, ... )  ( new t( __VA_ARGS__ ))
#endif

#ifndef PERIMETER_PImplPrivTemp_delete
#define PERIMETER_PImplPrivTemp_delete( o, t )  do{ delete PERIMETER_PImplPrivTemp_PtrCast( t*,  o ); }while(0)
#endif
...
public:   
    ...
    static T*    createInstance ( )           { return PERIMETER_PImplPrivTemp_new( T ); }
    static T*    createInstance ( void *ref ) { return PERIMETER_PImplPrivTemp_new( T,  * PERIMETER_PImplPrivTemp_PtrCast( T*, ref ) ); }
    static T*    addRef    ( void *cd )       {
        if ( cd != nullptr ) {
            PERIMETER_PImplPrivTemp_PtrCast( T*, cd )->addRefCntr( );
        }
        return  PERIMETER_PImplPrivTemp_PtrCast( T*, cd );
    }
...
#define PERIMETER_PImplPrivTemp_AttachPtr( t, s, d )\
    t :: attach( PERIMETER_PImplPrivTemp_PtrCast( void**, s ), PERIMETER_PImplPrivTemp_PtrCast( void**, d ))

#define PERIMETER_PImplPrivTemp_BuildIfNull( t, d ) \
    t :: buildIfNull( PERIMETER_PImplPrivTemp_PtrCast( void**, d ) )
...
T*   PImplPrivTemp<T> :: buildIfNull( void **w_obj )
{
    ...
    //return ( T *)( *w_obj );
    return PERIMETER_PImplPrivTemp_PtrCast( T*, *w_obj );
}
...
bool  PImplPrivTemp<T> :: releaseRef ( void *cd )
{
    ...
    if ( cd != nullptr ) {
        ...
        if ( PERIMETER_PImplPrivTemp_PtrCast( T*, cd )->releaseRefCntr() == 0 ) {
            PERIMETER_PImplPrivTemp_delete( cd, T );
            is_released = true;
        }
    }   	
    return is_released;
...
T *    PImplPrivTemp<T> :: duplicateIfShared( void **w_obj )
{
    ...
    if ( this->currRefCntr( ) == 1 ) { return PERIMETER_PImplPrivTemp_PtrCast( T *, *w_obj ); }
...
//    if ( (( T *) *w_obj)->currRefCntr( ) == 1 ) { return ( T *)( *w_obj ); }
    if ( PERIMETER_PImplPrivTemp_PtrCast( T*, *w_obj)->currRefCntr( ) == 1 ) {
        return PERIMETER_PImplPrivTemp_PtrCast( T*, *w_obj );
    }
