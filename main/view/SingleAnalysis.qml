...
Column {
    ...
    Item{width: parent.width;height: parent.height*14/15;id:content;}
    Rectangle
    {
        ...
        Row{
            ...
            Item{
                height: parent.height;width:parent.width*0.52;
                Item{
                    anchors.fill: parent
                    anchors.margins:parent.height*0.15;
                    Flow
                    {
                        height: parent.height;spacing: height*0.8;width: parent.width
